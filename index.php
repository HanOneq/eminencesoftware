    ...
    <body id="page-top">
        ...
        <header style="background-image: url('img/agency/backgrounds/bg-header.jpg');">
            <div class="intro-content">
                ...
                <hr class="colored">
                <!--<p>We are a New York based IT Company</p>-->
                ...
                <div class="row text-center content-row">
                    <div class="col-md-3 col-sm-6 wow fadeIn" data-wow-delay=".4s">
                        <div class="about-content">
                            ...
                            <ul>
                                ...
                                <li><i class=""></i> Webforms of all types</li>
                                <li><i class=""></i> Landing pages</li>
                                <li><i class=""></i> Event Calendars</li>
                                <li><i class=""></i> Email Marketing Solutions</li>
                                <li><i class=""></i> Programming & Database work</li>
                                <li><i class=""></i> CRM Systems</li>
                                <li><i class=""></i> Ecommerce Applications</li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-6 wow fadeIn" data-wow-delay=".2s">
                        <div class="about-content">
                            ...
                            <h3>iOS Apps</h3>
                            <p>We are able to work on iPhone or iPad applications using the latest Swift programming language. Feel free to talk to us about your requirements.</p>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-5 col-md-push-7">
                            <div class="project-details">
                                <span class="project-name">Menshealth.com</span>
                                <span class="project-description">Drupal CMS Maintenance and Support</span>
                                <hr class="colored">
            ...
            <div class="item" style="background-image: url('img/agency/portfolio/carousel/bg-2.jpg')">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-5 col-md-push-7">
                            <div class="project-details">
                                <span class="project-name">Essence.com</span>
                                <span class="project-description">Drupal Development</span>
                                <hr class="colored">
            ...
            <div class="item" style="background-image: url('img/agency/portfolio/carousel/bg-3.jpg')">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-5 col-md-push-7">
                            <div class="project-details">
                                <span class="project-name">People En Espanol Magazine</span>
                                <span class="project-description">Website Maintenance and Support</span>
                                <hr class="colored">
            ...
            <!--<div class="item" style="background-image: url('img/agency/portfolio/carousel/bg-4.jpg')">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-5 col-md-push-7">
                            <div class="project-details">
                                <span class="project-name">Computersforyouth</span>
                                <span class="project-description">PHP Programming and Database work</span>
                                <hr class="colored">
        ...
        <?php //include('inc/testmonials.php'); ?>
                ...
                <div class="row">
                    <div class="col-lg-8 col-lg-offset-2">
                        ...
                        <div id="mc_embed_signup">
                            ...
                            <form role="form" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" target="_blank">
                                <div class="input-group input-group-lg">
                                    <input type="email" name="EMAIL" class="form-control" id="mce-EMAIL" placeholder="Email address...">
                                    <span class="input-group-btn">
                                        <button type="button" name="subscribe" id="mc-embedded-subscribe" class="btn btn-primary">Subscribe!</button>
                                    </span>
                                </div>
        ...
        <a href="#contact" class="btn btn-block btn-full-width">Contact us Now!</a>
            ...
            <div class="container text-center">
                <div class="row">
                    <div class="col-md-4 contact-details">
                        ...
                        <p><a href="tel:518-512-9261">518-512-9261</a></p>
                    </div>
                    <div class="col-md-4 contact-details">
                        <h4><i class="fa fa-map-marker"></i> Visit</h4>
                        <p>P.O.Box 1063
                        <br>Clifton Park, NY 12065</p>
                    </div>
                    <div class="col-md-4 contact-details">
